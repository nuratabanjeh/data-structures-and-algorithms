...
def left_join(first_hash_table,second_hash_table):
    ...
    for word in first_hash_table._buckets:
        ...
        if word:
            array=[]
            array.append(word.head.value[0])
            array.append(first_hash_table.get(word.head.value[0]))
            array.append(second_hash_table.get(word.head.value[0]))
